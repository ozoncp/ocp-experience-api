...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-experience-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-experience-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-experience-api/bin/ocp-experience-api .
RUN chown root:root ocp-experience-api
EXPOSE 82
CMD ["./ocp-experience-api"]
