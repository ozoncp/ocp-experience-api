...
func (m *MockRepo) Add(arg0 []models.Experience) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) Describe(arg0 uint64) (*models.Experience, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) List(arg0, arg1 uint64) ([]models.Experience, error) {
	m.ctrl.T.Helper()
